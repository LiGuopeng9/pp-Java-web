...
<html>
  ...
  <body>
    ...
    <form class="register_form" action="register" method="post" enctype="multipart/form-data">
      
      <div class="form-group row">
        <label class="col-3   offset-2 register_lable">用户名</label>
        <div class="col-7 ">
          <input type="text" class="  form-control register_input" id="userid" name="userid" placeholder="请输入用户名">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-3   offset-2 register_lable">昵称</label>
        <div class="col-7 ">
          <input type="text" class="  form-control register_input" id="username" name="username" placeholder="请输入昵称">
        </div>
      </div>
      ...
      <div class=" btn-toolbar">
        ...
        <div class=" offset-9">
          <button type="submit" class="btn btn-primary register_btn" onclick="submit();">注册
          </button>
        </div>
      </div>
    </form>
